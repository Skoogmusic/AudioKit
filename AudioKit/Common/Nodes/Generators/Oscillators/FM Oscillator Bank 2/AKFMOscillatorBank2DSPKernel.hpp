...
#ifndef AKFMOscillatorBank2DSPKernel_hpp
#define AKFMOscillatorBank2DSPKernel_hpp
...
class AKFMOscillatorBank2DSPKernel : public DSPKernel {
public:
    // MARK: Types
    struct NoteState {
        NoteState* next;
...
#endif /* AKFMOscillatorBank2DSPKernel_hpp */
