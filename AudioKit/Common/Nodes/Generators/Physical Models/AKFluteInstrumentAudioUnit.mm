...
#import "AKFluteInstrumentDSPKernel.hpp"
...
@interface AKFluteInstrumentAudioUnit()
...
@implementation AKFluteInstrumentAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AKFluteInstrumentDSPKernel _kernel;
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription
    ...
    __block AKFluteInstrumentDSPKernel *blockKernel = &_kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
     ...
     */
    __block AKFluteInstrumentDSPKernel *state = &_kernel;
